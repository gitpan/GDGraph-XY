...
#
#	Name:
#		GD::Graph::xylinespoints.pm
#
# $Id: points.pm,v 1.9 2000/04/30 08:32:38 mgjv Exp $
#
#==========================================================================

package GD::Graph::xylinespoints;

$GD::Graph::xylinespoints::VERSION = '$Revision: 1.10 $' =~ /\s([\d.]+)/;
...
@GD::Graph::xylinespoints::ISA = qw( GD::Graph::axestype );
...
B<xylinespoints> is a I<perl5> module that uses GD::Graph, GD, 
to create and display PNG output for XY graphs with lines and points.
